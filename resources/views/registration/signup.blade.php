            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group form-control-default required">
                        ...
                        <input type="text" id="user" name="user" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" placeholder="Nombre" ng-model="signup.user" required="">
                    </div>
                </div>
            </div>
            <div class="form-group form-control-default required">
                <label>Email</label>
                <input type="email" id="email" name="email" class="form-control ng-pristine ng-untouched ng-valid-email ng-invalid ng-invalid-required" placeholder="Email" ng-model="signup.email" required="">
            </div>
            <div class="form-group form-control-default required">
                <label>Password</label>
                <input type="password" id="password" name="password" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" placeholder="Password" ng-model="signup.password" required="">
            </div>
            <div class="form-group form-control-default required">
