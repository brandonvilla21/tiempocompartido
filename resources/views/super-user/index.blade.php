                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    @if ( isset($promocion->imagenes[0]) )
                                        <img src="uploads/promociones/{{ $promocion->imagenes[0]->src }}" style="width:100%" class="card-image-desktop">
                                        <img src="uploads/promociones/{{ $promocion->imagenes[0]->src }}" style="width:100%" class="card-image-mobile w-100">
                                    @else 
